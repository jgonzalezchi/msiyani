...
var addToHome = (function (w) {
	var nav = w.navigator,
		...
		intl = {
			...
			cs_cz: 'Pro instalaci aplikace na Vá? %device, stiskn?te %icon a v nabídce <strong>P?idat na plochu</strong>.',
			da_dk: 'Tilføj denne side til din %device: tryk på %icon og derefter <strong>Føj til hjemmeskærm</strong>.',
			de_de: 'Installieren Sie diese App auf Ihrem %device: %icon antippen und dann <strong>Zum Home-Bildschirm</strong>.',
			el_gr: '????????????? ????? ??? ???????? ???? ??????? ??? %device: %icon ???? π????? <strong>???????? ?? ????????</strong>.',
			...
			hu_hu: 'Telepítse ezt a web-alkalmazást az Ön %device-jára: nyomjon a %icon-ra majd a <strong>F?képerny?höz adás</strong> gombra.',
